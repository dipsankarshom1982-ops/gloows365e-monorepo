// PATH: apps/web/src/lib/aiGuru/types.ts
// Mirror of apps/mobile/lib/aiGuru/types.ts — same shapes, so the lesson
// JSON returned by the generateLesson Cloud Function renders identically
// on web and mobile.
