// PATH: apps/web/src/lib/ads/types.ts
// Direct port of mobile's lib/ads/types.ts — these types are pure data
// shapes (no platform-specific imports), so this is an exact mirror.
...
export interface Ad {
  ...
  ctaRoute?: string;             // internal route (Next.js path on web, Expo path on mobile)
  sponsorName: string;
