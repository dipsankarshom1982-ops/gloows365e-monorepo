// PATH: apps/web/src/lib/discover/types.ts
// Mirror of apps/mobile/lib/discover/types.ts — same shapes, so the
// discoverSearch Cloud Function response renders identically on web/mobile.
