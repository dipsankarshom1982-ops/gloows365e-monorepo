// PATH: apps/web/src/services/dashboardApi.ts
// Mirror of apps/mobile/services/dashboardApi.ts — fetches the personalized
// AI Dashboard payload (usage stats, study plan, revision items, recent
// lessons, AI insight) from the getPersonalizedDashboard Cloud Function.
