// PATH: apps/web/src/services/photoSolveApi.ts
// Direct port of mobile's services/photoSolveApi.ts.
//
// FIX: the photo-solve page was calling `${CF_URL}/photoSolveAiGuru` —
// that function doesn't exist; the real exported name is `photoSolve`
// (functions/src/photoSolve.ts, exported via index.ts). It was also
// rendering the response as plain text (data.solution ?? data.answer)
// instead of the real structured shape below.
