// PATH: apps/web/src/services/aiGuruApi.ts
// Mirror of apps/mobile/services/aiGuruApi.ts — Cloud Function calls for
// lesson generation and in-lesson follow-up questions.
...
export interface GenerateLessonResult {
  ...
  // true when this lesson was served from the shared cache (identical
  // board/class/subject/chapter/topic/language/difficulty/style requested
  // before) rather than freshly generated — didn't cost a free slot/credit.
  cached?: boolean;
}
