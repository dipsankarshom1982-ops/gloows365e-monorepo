// PATH: apps/web/src/services/adService.ts
// Direct port of mobile's services/adService.ts. All three Cloud Functions
// (getAds, recordAdEvent, claimAdReward) are platform-agnostic httpsCallable
// calls — this file is identical to mobile's except for where `functions`
// is imported from.
