// PATH: apps/web/src/hooks/useAdFeed.ts
// Direct port of mobile's hooks/useAdFeed.ts — pure React state/effects,
// no platform-specific APIs, so this is an exact mirror.
