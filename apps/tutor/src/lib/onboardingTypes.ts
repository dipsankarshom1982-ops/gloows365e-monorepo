// apps/tutor/src/lib/onboardingTypes.ts
// Local wizard state shape for app/onboarding/page.tsx and its step
// components. Field names here intentionally match
// @gloows/shared-logic's TutorProfile onboarding fields 1:1 so
// hydrating from a loaded tutorProfile and writing back to Firestore
// are both a plain spread — no field-renaming translation layer.
