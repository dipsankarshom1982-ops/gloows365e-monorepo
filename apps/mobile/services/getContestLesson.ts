// PATH: apps/mobile/services/getContestLesson.ts
// Lessons are generated lazily, per (contest, language), the first time a
// student in that language opens it — see functions/src/contestLesson.ts's
