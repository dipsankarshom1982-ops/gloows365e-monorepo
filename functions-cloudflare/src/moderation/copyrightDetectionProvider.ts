// PATH: functions-cloudflare/src/moderation/copyrightDetectionProvider.ts
//
...
// canonical moderation implementation at functions/src/moderation/copyrightDetectionProvider.ts
